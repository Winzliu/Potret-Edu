...
class AdminKaryawanEdit extends Component
{
    ...
    public function modal_tambah(){
        ...
        if ($this->karyawan_id) {
            ...
            $this->password = $karyawan->password;
            $this->role = $karyawan->role;
            $this->custom = $karyawan->custom;
            $this->employment_date = $karyawan->userDetail->employment_date;
    ...
    public function editKaryawan(){
        ...
        // dd($this->position);
        DB::beginTransaction();
        $this->employment_date = \Carbon\Carbon::createFromFormat('Y-m-d', $this->employment_date)->format('m/d/Y');
        try {
            sleep(1);
