<div class="h-screen md:block fixed hidden w-[22%] xl:w-1/6  py-5 bg-background">
  ...
  <div class="h-full flex flex-col justify-between items-center">
    ...
    <div class="">
      ...
      {{-- menu --}}
      <div class="mt-12 xl:mt-7 flex flex-col  items-center">
        @if(0==1)
        {{-- menu 1 --}}
        <a href="/waiter" wire:navigate
          class="{{ ($active == 'home') ? 'text-mainColor' : 'text-black' }} gap-14 xl:gap-10 text-center w-20 leading-3">
      ...
      {{-- KITCHEN START--}}
        @elseif(1==1)
        {{-- menu 1 --}}
        <div class="hover:bg-slate-200 p-4 pb-5 rounded-lg">
          <a wire:navigate href="/kitchen" class="{{ ($active == 'masakan') ? 'text-mainColor' : 'text-black' }} text-center w-20 leading-3 ">
            <svg class="ml-4 w-20"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        {{-- akhir menu 1 --}}
        {{-- menu 2 --}}
        <div class="hover:bg-slate-200 p-8 px-10 rounded-lg">
          <a wire:navigate href="/kitchen-menu" class="{{ ($active == 'kelolaMenu') ? 'text-mainColor' : 'text-black' }} text-black text-center w-20 space-y-2 leading-3 ">
            <svg class="w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path fill="currentColor" d="m8.1 13.34l2.83-2.83L3.91 3.5a4.008 4.008 0 0 0 0 5.66zm6.78-1.81c1.53.71 3.68.21 5.27-1.38c1.91-1.91 2.28-4.65.81-6.12c-1.46-1.46-4.2-1.1-6.12.81c-1.59 1.59-2.09 3.74-1.38 5.27L3.7 19.87l1.41 1.41L12 14.41l6.88 6.88l1.41-1.41L13.41 13z" />
            </svg>
