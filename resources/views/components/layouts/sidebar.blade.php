<div class="h-screen md:block fixed hidden w-[22%] xl:w-1/6  py-5 bg-background">
  ...
  <div class="h-full flex flex-col justify-between items-center">
    ...
    <div class="">
      ...
      {{-- menu --}}
      <div class="mt-12 xl:mt-7 flex flex-col items-center gap-2">
        @if(0==1)
        {{-- menu 1 --}}
      ...
      {{-- KITCHEN START--}}
        ...
        <div class="hover:bg-slate-200 p-4 px-8 rounded-lg text-center">
          <a wire:navigate href="/kitchen-menu" class="{{ ($active == 'kelolaMenu') ? 'text-mainColor' : 'text-black' }} text-center w-20 space-y-2 leading-3 ">
