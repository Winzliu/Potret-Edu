<div class="">
    ...
    <div class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 py-10 rounded-xl shadow-lg text-center border border-4 border-mainColor font-semibold">
            ...
            <div class="mt-4 flex flex-row justify-center gap-8 font-medium">
                <button wire:click="$set('confirmingToggle', false)" class="bg-red-500 px-8 py-2 text-white rounded-md">Tidak</button>
