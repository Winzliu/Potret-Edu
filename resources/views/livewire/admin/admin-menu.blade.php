<div class="xl:mt-6 mt-8 w-[95%] xl:w-full">
    ...
    <div class="flex justify-between items-start pb-5">
        ...
        <div class="flex gap-5">
            ...
            {{-- Search Bar --}}
            <label data-tip="Cari menu berdasarkan nama"
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-fourthColor/40  Color transition-all duration-300 even:bg-slate-200">
                        <th class="whitespace-nowrap text-center cursor-default font-medium">{{ ($menus->currentPage() -
                            1) *
                            $menus->perPage() + $loop->iteration }}</th>
                        <th class="max-w-10 whitespace-nowrap text-start cursor-default truncate font-medium">{{
                            $menu->menu_name }}</th>
                        ...
                        <td class="max-w-10 whitespace-nowrap text-center cursor-default truncate">{{
                            $menu->menu_allergen}}</td>
                        <td class="max-w-10 whitespace-nowrap text-center cursor-default truncate">{{
                            $menu->menu_description}}</td>
