...
">
    {{-- Kembali --}}
    <a href="/admin/riwayat-pesanan" wire:navigate class="flex items-center gap-2 font-bold">
    ...
    <div class="my-2">
        ...
        <div class="flex xl:flex-row flex-col-reverse gap-10">
            ...
            {{-- Bagian Kanan Bill --}}
            <div class="bg-fourthColor shadow-xl rounded-lg p-5 mx-auto xl:w-5/12 w-1/2 text-center">
                <p class="font-bold
                @if(auth()->user()->userDetail->custom == 'kecil')
                text-lg
                @elseif(auth()->user()->userDetail->custom == 'normal')
