<div class="xl:mt-6 mt-8 w-[95%] xl:w-full">
            ...
            <table class="table">
                ...
                <thead>
                    <tr class="text-base text-black bg-fourthColor">
                        ...
                        <th scope="col" class="px-6 py-3 text-center cursor-default">Kategori Menu</th>
                        ...
                        <th class="whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p>Apakah Anda yakin ingin menghapus kategori "<span class="text-red-500">{{
                                            $categoryName->menu_category_name }}</span>"?</p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p>PERINTAH INI AKAN IKUT MENGHAPUS <span class="text-red-500">SELURUH MENU</span>
                                        <br> YANG MEMILIKI KATEGORI "<span class="text-red-500">{{
                                            $categoryName->menu_category_name }}</span>". <br> Yakin Ingin Menghapus?
                                    </p>
                                    <div class="mt-4 flex flex-row justify-center gap-8 font-medium">
    ...
    {{-- pagination --}}
    <div class="mt-6 flex justify-end items-center gap-10 mt-5">
        {{ $menu_categories->links('livewire.admin.component.admin-pagination-link') }}
    </div>
    {{-- akhir pagination --}}
    {{-- loading --}}
    <dialog wire:loading wire:target="hapusKategoriMenu" wire:loading.attr="open" class="modal bg-black/30">
        <span
