<div class="pt-8 pe-8 xl:pe-0">
    ...
    <p class="font-bold text-3xl text-center">Edit Kategori Menu</p>
    {{-- form --}}
    <div
    ...
    <div class="fixed top-0 left-0 w-full h-full bg-slate-500 bg-opacity-30 flex justify-center items-center">
        <div
            ...
            <p>Apakah Anda yakin ingin mengedit Kategori Menu ini?</p>
            <div class="mt-4 flex flex-row justify-center gap-8 font-medium">
                ...
                <button wire:click="editKategoriMenu"
    ...
    {{-- AKHIR MODAL HAPUS --}}
    {{-- loading --}}
    <dialog wire:loading wire:target="editKategoriMenu" wire:loading.attr="open" class="modal bg-black/30">
        <span
