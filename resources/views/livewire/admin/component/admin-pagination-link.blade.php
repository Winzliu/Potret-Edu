<div class="">
  ...
  <nav role="navigation" aria-label="Pagination Navigation" class="items-end text-right">
    <div class="join shadow-[0_0_30px_0_rgba(0,0,0,0.1)]">
      ...
      <button wire:click="gotoPage({{ $page }})" class="join-item btn bg-fourthColor hover:bg-fourthColor">{{ $page
        }}</button>
      @else
